...
var menuState = {
	create: function() {
    	...
    	numSticks_arrow = game.add.sprite(game.width/2-game.cache.getImage('numsticks_slider').width/2 + 340, game.height/2-20, 'numSticks_arrow');
    	numSticks_arrow.inputEnabled = true;
    	boundingBox = new Phaser.Rectangle(game.width/2-game.cache.getImage('numsticks_slider').width/2, game.height/2+20, 400, 50);
